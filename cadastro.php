...
<h1>Cadastre-se</h1>
		...
		Curso: <br>
			...
			<select name = "course">
				...
				<option value = "iências Sociais">Ciências Sociais</option>
				...
				<option value = "Enfermagem e Obstetrícia">Enfermagem e Obstetrícia</option>
				...
				<option value = "Engenharia de Redes de Comunicação">Engenharia de Redes de Comunicação</option>
				...
				<option value = "Gestão em Saúde Coletiva">Gestão em Saúde Coletiva</option>
