...
<!-- // Mensagem de sucesso  -->
  ...
  <div class="container">
        ...
        <div class="cadastro-formulario" class="row">
          ...
          <input type="text" class="form-control mb-2 mr-sm-2 mb-sm-0" name="nome" pattern="[a-z\s]+$" placeholder="Nome" required oninvalid="setCustomValidity('Por favor, preencha o nome')" onchange="try{setCustomValidity('')}catch(e){}" / title="Preencha aqui com o seu nome ">
          <br>
