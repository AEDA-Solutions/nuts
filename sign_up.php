...
<!-- // Mensagem de sucesso  -->
  ...
  <div class="container">
        ...
        <div class="cadastro-formulario" class="row">
          ...
          <input type="text" class="form-control" name="name" pattern="[a-Z\s]+$" placeholder="Nome" required oninvalid="setCustomValidity('Por favor, preencha o nome')" onchange="try{setCustomValidity('')}catch(e){}" / title="Preencha aqui com o seu nome ">
          <br>
